...
type Props = {
  ...
  note?: string | null
  onClose: () => void
  onSave: (payload: { day: string; rating: number | null; note?: string | null }) => void
}

export default function RatingModal({ open, dateStr, rating, note, onClose, onSave }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-900 p-6 rounded-lg w-[320px] shadow-lg">
        ...
        <div className="mb-3">
          ...
          <select ref={ratingRef} defaultValue={rating ?? ''} className="w-full p-2 border rounded">
        ...
        <div className="mb-4">
          ...
          <textarea ref={noteRef} defaultValue={note ?? ''} className="w-full p-2 border rounded h-20" />
        </div>
